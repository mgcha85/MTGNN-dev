...
def plot_data(data,title):
    ...
    fig = plt.gcf()
    #plt.savefig('model/comparison/test3/'+title[0:4]+str(counter+1)+'.png', bbox_inches="tight")
...
###########################################################################################################
    ...
    with open('model/comparison/test3/'+type+'/'+title+'_'+type+'.txt',"w") as f:
...
def plot_predicted_actual(predicted, actual, title, type,variance, confidence_95):
    ...
    fig = plt.gcf()
    title=title.replace('/','_')
    plt.savefig('model/comparison/test3/'+type+'/'+title+'_'+type+'.png', bbox_inches="tight")
    plt.savefig('model/comparison/test3/'+type+'/'+title+'_'+type+".pdf", bbox_inches = "tight", format='pdf')
...
parser.add_argument('--save', type=str, default='model/comparison/test3/model.pt',
