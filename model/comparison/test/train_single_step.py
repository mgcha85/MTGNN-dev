...
def plot_data(data,title):
    ...
    fig = plt.gcf()
    #plt.savefig('model/comparison/test/'+title[0:4]+str(counter+1)+'.png', bbox_inches="tight")
...
###########################################################################################################
    ...
    with open('model/comparison/test/'+type+'/'+title+'_'+type+'.txt',"w") as f:
...
def plot_predicted_actual(predicted, actual, title, type,counter):
    ...
    fig = plt.gcf()
    title=title.replace('/','_')
    plt.savefig('model/comparison/test/'+type+'/'+title+'_'+type+'.png', bbox_inches="tight")
    plt.savefig('model/comparison/test/'+type+'/'+title+'_'+type+".pdf", bbox_inches = "tight", format='pdf')
...
parser.add_argument('--save', type=str, default='model/comparison/test/model.pt',
