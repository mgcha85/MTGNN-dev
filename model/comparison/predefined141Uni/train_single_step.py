...
def plot_data(data,title):
    ...
    fig = plt.gcf()
    #plt.savefig('model/comparison/predefined141/'+title[0:4]+str(counter+1)+'.png', bbox_inches="tight")
...
###########################################################################################################
    ...
    with open('model/comparison/predefined141/'+file_name+'.txt',"w") as f:
...
def plot_predicted_actual(predicted, actual, title, type,counter):
    ...
    plt.savefig('model/comparison/predefined141/'+title+'_'+type+'.png', bbox_inches="tight")
...
parser.add_argument('--save', type=str, default='model/comparison/predefined141/model.pt',
