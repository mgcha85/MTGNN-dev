...
def plot_predicted_actual(predicted, actual, title, counter):
...
def evaluate(data, X, Y, model, evaluateL2, evaluateL1, batch_size, is_plot):
    ...
    sum_squared_diff=0
    sum_absolute_diff=0
    r=random.randint(0, 140)#random column
...
def main(experiment):
    ...
    for q in range(60):
        ...
        print('valid=',int((0.6 + 0.15) * Data.n))
